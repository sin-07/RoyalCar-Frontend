    ...
    >
      ...
      >
        <div>
          ...
          >
            Whether it’s a weekend getaway or your daily commute, we’ve got the perfect luxury or everyday vehicle waiting for you
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
        ...
        >
          ...
          <div>
            ...
            <ul className="mt-3 flex flex-col gap-1.5">
              <li>Bajrangpuri West</li>
              <li>New arfabad colony</li>
              <li>+1 234 567890</li>
              <li>yeti@example.com</li>
            </ul>
          </div>
        </motion.div>
      </motion.div>
